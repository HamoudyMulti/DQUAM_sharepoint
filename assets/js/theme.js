    ...
    return {
      ...
      data: {
        ...
        datasets: [
          {
            label: 'Student A',
            backgroundColor: utils.rgbaColor(utils.getColor('info'), 0.3),
            borderColor: utils.getColor('info'),
            data: [20, 18, 33, 7, 12, 30],
            borderWidth: 1,
          },
          // {
          //   label: 'Student B',
              ...
              data: [
                {
                  ...
                  name: 'Resolved',
                  itemStyle: {
                    color: utils.rgbaColor(utils.getColors().success, 0.5),
                  },
                },
                {
                  value: 50,
  ...
  if ($echartMostLeads) {
    ...
    var getDefaultOptions = function getDefaultOptions() {
      return {
        color: [
          utils.getColors().primary,
          utils.rgbaColor(utils.getColors().success, 0.5),
          utils.getColors().info,
        ],
        tooltip: {
          trigger: 'item',
...
var echartsUnresolvedTicketsInit = function echartsUnresolvedTicketsInit() {
  ...
  if ($unresolvedTickets) {
    ...
    var emphasisStyle = {
      itemStyle: {
        shadowColor: utils.rgbaColor(utils.getColor('info'), 0.3),
      },
    };
